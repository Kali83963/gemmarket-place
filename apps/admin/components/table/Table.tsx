...
import UserTableHeader from "../users/table/UserTableHeaders";
...
function stableSort(
  ...
  const stabilizedThis = array?.map((el: UserProfile, index: number) => [
    el,
    index,
  ]);
                ...
                return (
                  ...
                  >
                    ...
                    <TableCell
                      ...
                      scope="row"
                      sx={
                        open ? { alignItems: "center", cursor: "pointer" } : {}
                      }
                    >
