...
const Chip = ({
  ...
  let defaultSX = {
    color:
      theme.palette.mode === ThemeMode.DARK ? "primary.light" : "primary.main",
    bgcolor:
      theme.palette.mode === ThemeMode.DARK ? "primary.main" : "primary.light",
    ":hover": {
      color: "primary.light",
      bgcolor:
    ...
    ":hover": {
      color:
        theme.palette.mode === ThemeMode.DARK
          ...
          : "primary.light",
      bgcolor:
        theme.palette.mode === ThemeMode.DARK ? "primary.main" : "primary.dark",
    },
  };
